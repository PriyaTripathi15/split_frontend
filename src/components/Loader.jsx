...
const StyledWrapper = styled.div`
  ...
  .loader {
    ...
    --background: linear-gradient(
      0deg,
      rgba(20, 184, 166, 0.2) 0%, /* teal-500 */
      rgba(6, 182, 212, 0.2) 100% /* cyan-500 */
    );
    height: var(--size);
    aspect-ratio: 1;
    position: relative;
  ...
  .loader .box {
    ...
    border-radius: 50%;
    border-top: 2px solid rgba(6, 182, 212, 0.8); /* cyan */
  ...
  @keyframes ripple {
    0% {
      transform: scale(1);
      box-shadow: rgba(6, 182, 212, 0.3) 0px 10px 10px;
    }
    50% {
      transform: scale(1.3);
      box-shadow: rgba(6, 182, 212, 0.5) 0px 30px 20px;
    }
    100% {
      transform: scale(1);
      box-shadow: rgba(6, 182, 212, 0.3) 0px 10px 10px;
